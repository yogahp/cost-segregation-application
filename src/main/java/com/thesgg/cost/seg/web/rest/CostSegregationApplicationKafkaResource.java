...
@RestController
@RequestMapping("/api/cost-segregation-application-kafka")
public class CostSegregationApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(CostSegregationApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CostSegregationApplicationKafkaResource(KafkaProperties kafkaProperties) {
