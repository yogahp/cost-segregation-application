...
import com.thesgg.cost.seg.config.KafkaProperties;
...
class CostSegregationApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        CostSegregationApplicationKafkaResource kafkaResource = new CostSegregationApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/cost-segregation-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/cost-segregation-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
